...
// RegisterResponse successResponse = new RegisterResponse(true, "Registration
// successful");
//
...
// "REGISTER|existinguser|password123|password123|SELLER";
// RegisterResponse failResponse = new RegisterResponse(false, "User already
// exists");
//
...
// LoginResponse response = new LoginResponse(true, "Success", "user",
// "BIDDER");
//
...
// LoginResponse response = new LoginResponse(true, "Success", "john_doe",
// "ADMIN");
//
// when(mockUserService.login(any(LoginRequest.class))).thenReturn(response);
//
