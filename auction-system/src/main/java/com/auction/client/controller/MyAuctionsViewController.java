...
public class MyAuctionsViewController {
	...
	@FXML
	private TableColumn<AuctionRow, String> colId, colItemName, colStart, colCurrent, colStartTime, colEndTime,
			colStatus, colAction;
		...
		colAction.setCellFactory(col -> new TableCell<>() {
			private final Button btn = new Button("👁 Xem");
			{
				...
				btn.setOnAction(e -> {
					...
					try {
						Session.get().setSelectedAuctionId(Long.parseLong(r.id.get()));
