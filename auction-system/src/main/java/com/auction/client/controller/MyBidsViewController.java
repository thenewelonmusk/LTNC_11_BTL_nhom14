...
public class MyBidsViewController {
    ...
    @FXML private TableView<MyBidRow> tblMyBids;
    @FXML private TableColumn<MyBidRow, String> colId;
    @FXML private TableColumn<MyBidRow, String> colAuctionId;
    @FXML private TableColumn<MyBidRow, String> colItemName;
    @FXML private TableColumn<MyBidRow, String> colAmount;
    @FXML private TableColumn<MyBidRow, String> colBidTime;
    @FXML private TableColumn<MyBidRow, String> colResult;
    ...
    public void handleReload() {
        ...
        if (json == null) { lblEmpty.setText("Không thể tải dữ liệu từ server."); return; }
