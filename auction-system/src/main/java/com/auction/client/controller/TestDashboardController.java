...
public class TestDashboardController {
    ...
    @FXML private TextField txtUsername, txtPassword, txtItemName, txtStartPrice, txtAuctionId, txtBidAmount;
    ...
    public void initialize() {
        if (cbCategory != null) cbCategory.getSelectionModel().selectFirst();
    }
    ...
    public void handleRegister() {
        RegisterRequest req = new RegisterRequest(txtUsername.getText(), txtPassword.getText(), txtPassword.getText(), "SELLER");
    ...
    public void handleCreateAndOpenAuction() {
        ...
        if (itemRes != null && itemRes.isSuccess()) {
            ...
            if (aucRes != null && aucRes.isSuccess()) {
                ...
                showAlert("Lỗi", "Tạo sản phẩm OK nhưng mở phiên thất bại: " + (aucRes != null ? aucRes.getMessage() : "N/A"));
            }
        } else {
    ...
    public void handlePlaceBid() {
        ...
        try {
            ...
            showAlert(res.isSuccess() ? "Thành công" : "Thất bại", res.getMessage() + "\nGiá hiện tại: " + res.getCurrentPrice());
        } catch (Exception e) {
