...
public class ItemFormViewController {
	...
	@FXML
	private TextField txtDeviceBrand, txtWarrantyMonths;
	@FXML
	private TextField txtArtist, txtYear;
	@FXML
	private TextField txtVehicleBrand, txtMileage;
	...
	private void updateTypeFields(String type) {
		...
		boxElectronics.setVisible(isElec);
		boxElectronics.setManaged(isElec);
		boxArt.setVisible(isArt);
		boxArt.setManaged(isArt);
		boxVehicle.setVisible(isVeh);
		boxVehicle.setManaged(isVeh);
	}
