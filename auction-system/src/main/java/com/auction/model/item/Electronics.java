...
public class Electronics extends Item {
    ...
    private int getWarrantyMonths() {return warrantyMonths;}
    private String getDeviceBrand() {return deviceBrand;}

    public void setDeviceBrand(String brand) {this.deviceBrand = brand;}
