...
public class UserDAO {
	...
	/**
	 * Tra cứu username theo id. Dùng cho broadcast hiển thị tên người đặt giá thay
	 * vì hiển thị "User #5" trông rất khó hiểu. Trả về null nếu không tìm thấy
	 * (không ném exception để caller dùng nhẹ nhàng).
	 */
