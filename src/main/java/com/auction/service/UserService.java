...
public interface UserService {
	 ...
	 *
	 * @param request
	 *            the {@link LoginRequest} containing username and password
	 * @return {@link LoginResponse} with authentication result and user details if
	 *         successful
	 ...
	 *
	 * @param request
	 *            the {@link RegisterRequest} containing username, password,
	 *            confirmation password, and role
