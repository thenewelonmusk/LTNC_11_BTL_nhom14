...
/**
 * Singleton lưu thông tin user đang đăng nhập trong phiên client. Các
 * controller có thể đọc Session.get() để biết userId, role, username.
 */
public class Session {
	...
	public void setSelectedAuctionId(Long id) {
