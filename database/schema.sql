...
--  hệ thống đấu giá trực tuyến (users, items, auctions, bids, auto_bids).
--
--  Cách chạy:
...
-- =====================================================================
--  Bảng AUTO_BIDS — đăng ký đấu giá tự động
--  Khớp với AutoBidEntry.java
-- =====================================================================
CREATE TABLE auto_bids (
    ...
    increment_step DECIMAL(18,2) NOT NULL DEFAULT 1000,
    active         TINYINT(1)    NOT NULL DEFAULT 1,
    registered_at  TIMESTAMP     NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY (id),
    UNIQUE KEY uk_autobid_auction_bidder (auction_id, bidder_id),
    INDEX idx_autobids_active (active),
...
INSERT INTO bids (auction_id, bidder_id, amount, auto_bid) VALUES
    (1, 4, 25100000, 0),
    (1, 5, 25200000, 0),
    (1, 6, 25350000, 0),
    (1, 4, 25500000, 0);
